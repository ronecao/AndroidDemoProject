...
import com.transactionplatform.framework.TransactionPlatform;
import com.transactionplatform.framework.TransactionPlatformListener;
import com.transactionplatform.framework.ConfirmCard;
import com.transactionplatform.framework.TransactionPlatform;
import com.transactionplatform.framework.TransactionPlatformListener;
...
public class MainActivity extends AppCompatActivity implements TransactionPlatformListener {
   ...
   public void transactionMessageUpdate(String msg)
    ...
    public void transactionSaleCompleted(String resultDict){
        ...
        try {
            ...
            modulevalue=file.getModuleValue(TransactionPlatform.getmModule());
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.initBtn:
                    ...
                    cmsf= new TransactionPlatform(getApplicationContext(),mAPITokenText.getText().toString(),MainActivity.this);
                    break;
                case R.id.saleBtn:
                ...
                case R.id.capBtn:
                    ...
                    FragmentManager manager = getFragmentManager();
                    FileOpt file= new FileOpt(getApplication());
                    JSONArray transarray= file.getTranactions(file.getModuleValue(TransactionPlatform.getmModule()),file.AUTH);
                ...
                case R.id.voidBtn:
                    ...
                    JSONArray transarray2= file2.getTranactions(file2.getModuleValue(TransactionPlatform.getmModule()),file2.SALE);
