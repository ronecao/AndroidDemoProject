...
import com.cmsonline.framework.EMVIOAndroidBridge;
...
public class WebWrapperFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mwebView.addJavascriptInterface(new EMVIOAndroidBridge(getContext(),mwebView), "EMVIO");//EMVIO is id window.EMVIO.function name
