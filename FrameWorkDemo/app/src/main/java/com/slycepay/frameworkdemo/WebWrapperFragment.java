...
import com.slycepay.framework.SlycePayAndroidBridge;
...
public class WebWrapperFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mwebView.addJavascriptInterface(new SlycePayAndroidBridge(getContext(),mwebView), "EMVIO");//EMVIO is id window.EMVIO.function name
